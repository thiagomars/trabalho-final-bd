...
public class ConsultarUsuarios extends javax.swing.JFrame {
    ...
    public void dadosTabela(){
        ...
        JDBCUsuarios user = new JDBCUsuarios(con.abrirConexao());
        
        ArrayList<Usuario> usuarios = user.listarUsers();
        con.fecharConexao();
        ...
        for (Usuario u:usuarios){
            Object[] dados = {u.getUsuario(), u.getNome(), u.getTipo_user(), u.getEndereco()};
            modelo.addRow(dados);
        }
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Usuario", "Nome", "Tipo usuário", "Endereço"
            }
        ));
